...
public class RecommenderTest {
    ...
    public void RecommenderTest() {
        ...
        Location location2 = new Location("Sunset Cafe", 143f, 22.23f, cafeReview);
        ...
        Location location6 = new Location("House of Gourmet", 43.662f, -79.395f, houseofGourmetReview);
